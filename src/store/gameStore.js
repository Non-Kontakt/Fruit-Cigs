...
export const useGameStore = create((set, get) => ({
  ...
  latestHeadline: null, // { category, headline, byline, week, season }
  recentScorelines: [],
  ...
  setConsecutiveCleanSheets: (val) => set(s => ({ consecutiveCleanSheets: typeof val === "function" ? val(s.consecutiveCleanSheets) : val })),

  setHalfwayPosition: (val) => set({ halfwayPosition: val }),
  setPreviousLeaguePosition: (val) => set({ previousLeaguePosition: val }),
  setLatestHeadline: (val) => set({ latestHeadline: val }),
  ...
  resetToMenu: () => set({
    ...
    clubHistory: {
      ...
      bestWinStreak: 0, bestUnbeatenRun: 0, worstLossStreak: 0,
      biggestWin: null, worstDefeat: null, bestSeasonFinish: null, bestSeasonPoints: 0,
      playerCareers: {}, allTimeXI: {}, seasonArchive: [], cupHistory: [], rivalryLedger: {},
    },
    allTimeLeagueStatsByTier: {},
    seasonLeagueStatsByTier: {},
    seasonLeagueStatsAvailable: true,
