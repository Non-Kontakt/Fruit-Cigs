...
| **1** | Intergalactic Elite | Players age 3 years per season; draws pay the player 1 point, the AI 2; 3 Rewind tickets per season (replay a lost league match) |
...
1. **Thin spread.** Tier 1's team-strength range is 17–19 OVR — a top-to-bottom spread of about 0.35 OVR once the prestige-0 cap is applied, versus 0.83 at tier 2. It's still the tightest field on the ladder, but it's no longer a dead-flat 0.25: there are now genuinely weaker sides to target, not just a rounding error's worth of separation.
2. **Very little headroom.** Tier 1's OVR ceiling (20) is the prestige-0 cap, and the AI field now centres around 19.2 rather than sitting on top of it — a maxed-out squad clears the average field instead of merely tying it, though the strongest AI sides are still close behind.
3. **You arrive undercooked.** World XI Invitational's 0.15× training multiplier means the squad that gets promoted into tier 1 has gained almost nothing the previous season — sim data puts an arriving squad around 17.5 average strength against a tier-1 field that's now centred closer to 19.2 rather than ~19.5.
4. **The point rules still cost you on top of the football.** 1-point player draws (vs 2 for the AI) work against you regardless of how well you actually play.
5. **You can't train your way out in one season.** Growth at attr levels 17–20 is close to zero (see the levelFactor table above) and the 3-years-per-season aging rate pushes your squad toward decline rather than growth. The upshot: **getting relegated straight back down after a promotion is still the expected outcome for most arriving squads, not a sign you played badly** — though the wall is measurably less absolute than it used to be.

Practically: expect to yo-yo between tiers 1 and 2 for a season or two before a title actually sticks. Build the deepest bench you can before promotion, don't panic when you're outclassed on arrival, and save your Rewind tickets for the matches your own mistakes cost you. If you do get relegated straight back out, at least you'll walk away with Trask Ulgo.
